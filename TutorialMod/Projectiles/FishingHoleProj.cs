...
{
    public class FishingHoleProj : ModProjectile
    {
        ...
        public static void PlaceHole(int x, int y, Vector2 position, int side, Player player)
        {
                ...
                for (int i = 0; i < 3; i++)
                {
                    for (int x = 11; x > -1; x--)
                    {
                        ...
                        for (int y = -6; y <= 1; y++)
                        {
                            ...
                            if (i == 0)
                            {
                                PlaceHole(x, y, position, 1, player);
                            }
                            else if (i == 1)
                            {
